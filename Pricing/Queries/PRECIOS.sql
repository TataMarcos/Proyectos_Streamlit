...
SELECT
    ...
    AVG(STCK_PRECIO_VENTA_DIA_CIVA) AS PRECIO_PROMEDIO
FROM
    MSTRDB.DWH.FT_STOCK
WHERE
    TIEM_DIA_ID = {cond2}
...
SELECT
    ...
    END AS COSTO_UNITARIO, FCUR.ORIGIN_COUNTRY_ID AS MONEDA_COSTO,
...
SELECT
    LAA.ORIN, LGL.GEOG_LOCL_COD AS LOCAL, PVP_ACTUAL, PRECIO_MEDIANO, PRECIO_PROMEDIO,
