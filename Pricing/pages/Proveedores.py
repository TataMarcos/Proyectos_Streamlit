    ...
    if 'prov_filtros' in st.session_state and 'proveedores' not in st.session_state:
        ...
        proveedores = st.data_editor(
            ...
            column_config={"ESTADO": st.column_config.SelectboxColumn("Estado", options=opc, required=True),
                        ...
                        "PVP_ACTUAL":st.column_config.NumberColumn('PVP Actual', format='$ %.0f'),
                        "MG_ACTUAL":st.column_config.NumberColumn('Margen Actual', format='percent'),
                        "PVP_SUGERIDO":st.column_config.NumberColumn('PVP Sugerido', format='$ %.0f'),
                        "MG":st.column_config.NumberColumn('Margen Objetivo', format='percent'),
                        "PVP_MARGEN_OBJETIVO":st.column_config.NumberColumn('PVP Margen Objetivo', format='$ %.0f'),
